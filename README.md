# Hashmap
Create a report that will display the isbn, book title, author's name and bio based from the given diagram in the file:
...
Use the given sequence diagram in the file in the implementation of the codes:
